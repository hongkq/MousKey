...
class Filemain extends JFrame implements ActionListener {
...
//以下为按钮、滑动条注册监听者
    adminType.addActionListener(this);
...
//以下一行用于窗口事件监听者注册
    ...
    public void changePerformed(ActionEvent e){
        //定义一个监听器，用于监听所有滑动条
