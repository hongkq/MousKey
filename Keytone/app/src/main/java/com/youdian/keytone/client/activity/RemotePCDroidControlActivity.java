...
import com.youdian.keytone.client.activity.connection.RemotePCDroidConnListActivity;
...
public class RemotePCDroidControlActivity extends Activity implements RemotePCDroidActionReceiver
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		Log.d("wwww","=========="+this.application.getClass().getName());
		Log.d("aaa","===+++++++++++++++======="+this.getApplication().getClass().getName());
